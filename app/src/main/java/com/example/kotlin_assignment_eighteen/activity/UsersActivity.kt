...
class UsersActivity : AppCompatActivity(), EasyPermissions.PermissionCallbacks {
    ...
    private val defaultImageURL = "https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg"
    ...
    private fun onClickCreateUser() {
        with(binding) {
            if (civProfilePhoto.equals(defaultImageURL) || etFullName.text.isNullOrEmpty() ||
        ...
        NetworkConfig().getServiceUser()
            ...
            .enqueue(object : Callback<CreateDataResponse>{
                override fun onResponse(
                    ...
                    Toast.makeText(this@UsersActivity, "Insert Data Succeed", Toast.LENGTH_SHORT).show()
                }

                override fun onFailure(call: Call<CreateDataResponse>, t: Throwable) {
                    Toast.makeText(this@UsersActivity, "Insert Data Failed", Toast.LENGTH_SHORT).show()
                }
    ...
    private fun onClickUploadImage() {
        if (EasyPermissions.hasPermissions(this, android.Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            EasyPermissions.requestPermissions(this, "Izinkan Aplikasi Mengakses Storage?",
            ...
            .enqueue(object: Callback<UploadImageResponse>{
                override fun onResponse(
                    ...
                    if (response.body()?.status == 0) {
                        Toast.makeText(this@UsersActivity, response.body()!!.message, Toast.LENGTH_SHORT).show()
                    } else {
                ...
                override fun onFailure(call: Call<UploadImageResponse>, t: Throwable) {
                    Toast.makeText(this@UsersActivity, t.localizedMessage, Toast.LENGTH_SHORT).show()
                }
